...
public interface fj extends IInterface
{
    ...
    public abstract static class a extends Binder implements fj
    {
        ...
        public static fj zzS(final IBinder binder) {
            ...
            if (queryLocalInterface != null && queryLocalInterface instanceof fj) {
                return (fj)queryLocalInterface;
            }
            return new fj.a.a(binder);
        }
