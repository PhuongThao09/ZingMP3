...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, Callback
{
    ...
    private PanelFeatureState getPanelState(final int n, final boolean b) {
        ...
        if (panelFeatureState == null) {
            return mPanels2[n] = new PanelFeatureState(n);
        }
        return panelFeatureState;
    }
    ...
    boolean onKeyDown(final int n, final KeyEvent keyEvent) {
        ...
        switch (n) {
            case 82: {
                if (this.onKeyDownPanel(0, keyEvent)) {
                    return true;
                }
                break;
            }
    ...
    boolean onKeyUp(final int n, final KeyEvent keyEvent) {
        switch (n) {
            case 82: {
                if (this.onKeyUpPanel(0, keyEvent)) {
                    return true;
                }
                break;
            }
    ...
    public void setSupportActionBar(final Toolbar toolbar) {
        ...
        final ToolbarActionBar supportActionBar = new ToolbarActionBar(toolbar, ((Activity)this.mContext).getTitle(), this.mAppCompatWindowCallback);
    ...
    Label_0052:
        while (true) {
            ...
            while (true) {
                while (true) {
                    try {
                        final ActionMode onWindowStartingSupportActionMode = this.mAppCompatCallback.onWindowStartingSupportActionMode(actionModeCallbackWrapperV7);
