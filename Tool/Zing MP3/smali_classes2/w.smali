...
.method public static a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Lw;
    ...
    iget-object v2, v0, Lw;->b:Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v1, v2}, Lw$g;-><init>(Landroid/graphics/drawable/Drawable$ConstantState;)V

    iput-object v1, v0, Lw;->h:Landroid/graphics/drawable/Drawable$ConstantState;
    ...
    .line 596
    :cond_3
    invoke-static {p0, v0, v1, p2}, Lw;->a(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)Lw;
    :try_end_0
...
.method private b(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .line 753
    iget-object v3, p0, Lw;->c:Lw$f;

    .line 754
    iget-object v4, v3, Lw$f;->b:Lw$e;
    ...
    .line 773
    invoke-virtual {v1, p1, p3, p4, p2}, Lw$b;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V

    .line 774
    iget-object v0, v0, Lw$c;->b:Ljava/util/ArrayList;

    invoke-virtual {v0, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 775
    invoke-virtual {v1}, Lw$b;->getPathName()Ljava/lang/String;
    ...
    .line 776
    iget-object v0, v4, Lw$e;->h:Ldw;

    invoke-virtual {v1}, Lw$b;->getPathName()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v0, v7, v1}, Ldw;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 782
    invoke-virtual {v7, p1, p3, p4, p2}, Lw$a;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 784
    invoke-virtual {v7}, Lw$a;->getPathName()Ljava/lang/String;
    ...
    invoke-virtual {v0, v8, v7}, Ldw;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 790
    invoke-virtual {v7, p1, p3, p4, p2}, Lw$c;->a(Landroid/content/res/Resources;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;Lorg/xmlpull/v1/XmlPullParser;)V
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    .line 310
    :cond_1
    iget-object v0, p0, Lw;->k:Landroid/graphics/Rect;
    ...
    .line 317
    iget-object v0, p0, Lw;->f:Landroid/graphics/ColorFilter;

    if-nez v0, :cond_8

    iget-object v0, p0, Lw;->e:Landroid/graphics/PorterDuffColorFilter;

    .line 323
    :goto_1
    iget-object v1, p0, Lw;->j:Landroid/graphics/Matrix;
    ...
    iget-object v3, p0, Lw;->i:[F

    invoke-virtual {v1, v3}, Landroid/graphics/Matrix;->getValues([F)V

    .line 325
    iget-object v1, p0, Lw;->i:[F
    ...
    .line 337
    :cond_3
    iget-object v6, p0, Lw;->k:Landroid/graphics/Rect;
    ...
    .line 347
    iget-object v1, p0, Lw;->k:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->left:I

    int-to-float v1, v1

    iget-object v8, p0, Lw;->k:Landroid/graphics/Rect;
    ...
    invoke-virtual {p0}, Lw;->getLayoutDirection()I
    ...
    .line 361
    iget-object v2, p0, Lw;->c:Lw$f;

    .line 2027
    iget-object v1, v2, Lw$f;->f:Landroid/graphics/Bitmap;
    ...
    iput-object v1, v2, Lw$f;->f:Landroid/graphics/Bitmap;

    .line 2030
    iput-boolean v4, v2, Lw$f;->k:Z

    .line 362
    :cond_6
    iget-boolean v1, p0, Lw;->d:Z

    if-nez v1, :cond_b

    .line 363
    iget-object v1, p0, Lw;->c:Lw$f;

    invoke-virtual {v1, v3, v6}, Lw$f;->a(II)V
    ...
    iget-object v3, p0, Lw;->k:Landroid/graphics/Rect;

    .line 4000
    iget-object v1, v2, Lw$f;->b:Lw$e;

    invoke-virtual {v1}, Lw$e;->getRootAlpha()I
    ...
    .line 2044
    iget-boolean v2, v1, Lw$f;->k:Z

    if-nez v2, :cond_c

    iget-object v2, v1, Lw$f;->g:Landroid/content/res/ColorStateList;

    iget-object v8, v1, Lw$f;->c:Landroid/content/res/ColorStateList;

    if-ne v2, v8, :cond_c

    iget-object v2, v1, Lw$f;->h:Landroid/graphics/PorterDuff$Mode;

    iget-object v8, v1, Lw$f;->d:Landroid/graphics/PorterDuff$Mode;

    if-ne v2, v8, :cond_c

    iget-boolean v2, v1, Lw$f;->j:Z

    iget-boolean v8, v1, Lw$f;->e:Z

    if-ne v2, v8, :cond_c

    iget v2, v1, Lw$f;->i:I

    iget-object v1, v1, Lw$f;->b:Lw$e;
    ...
    .line 2057
    iget-object v2, v1, Lw$f;->c:Landroid/content/res/ColorStateList;

    iput-object v2, v1, Lw$f;->g:Landroid/content/res/ColorStateList;

    .line 2058
    iget-object v2, v1, Lw$f;->d:Landroid/graphics/PorterDuff$Mode;

    iput-object v2, v1, Lw$f;->h:Landroid/graphics/PorterDuff$Mode;

    .line 2059
    iget-object v2, v1, Lw$f;->b:Lw$e;

    invoke-virtual {v2}, Lw$e;->getRootAlpha()I
    ...
    .line 2060
    iget-boolean v2, v1, Lw$f;->e:Z

    iput-boolean v2, v1, Lw$f;->j:Z

    .line 2061
    iput-boolean v5, v1, Lw$f;->k:Z
    ...
    .line 3011
    :cond_e
    iget-object v1, v2, Lw$f;->l:Landroid/graphics/Paint;
    ...
    iput-object v1, v2, Lw$f;->l:Landroid/graphics/Paint;
    ...
    iget-object v4, v2, Lw$f;->b:Lw$e;

    invoke-virtual {v4}, Lw$e;->getRootAlpha()I
    ...
    .line 3017
    iget-object v0, v2, Lw$f;->l:Landroid/graphics/Paint;
...
.method public final inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .line 648
    iput-object v0, v1, Lw$f;->b:Lw$e;

    .line 650
    sget-object v0, Lr;->a:[I

    invoke-static {p1, p4, p3, v0}, Lw;->a(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {v2, p2, v0, v5}, Lu;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;I)I
    ...
    :goto_1
    :pswitch_0
    iput-object v0, v3, Lw$f;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    .line 4705
    iput-object v0, v3, Lw$f;->c:Landroid/content/res/ColorStateList;

    .line 4708
    :cond_2
    const-string/jumbo v5, "autoMirrored"

    iget-boolean v0, v3, Lw$f;->e:Z

    .line 6040
    invoke-static {p2, v5}, Lu;->a(Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;)Z
    ...
    invoke-static {v2, p2, v0, v3, v5}, Lu;->a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Ljava/lang/String;IF)F
    ...
    .line 4741
    invoke-virtual {v4}, Lw$e;->getAlpha()F
    ...
    .line 4742
    invoke-virtual {v4, v0}, Lw$e;->setAlpha(F)V
    ...
    .line 4746
    iput-object v0, v4, Lw$e;->g:Ljava/lang/String;

    .line 4747
    iget-object v3, v4, Lw$e;->h:Ldw;
    ...
    .line 659
    iget-object v0, v1, Lw$f;->c:Landroid/content/res/ColorStateList;

    iget-object v1, v1, Lw$f;->d:Landroid/graphics/PorterDuff$Mode;
...
.method protected final onStateChange([I)Z
    ...
    iget-object v0, v0, Lw$f;->d:Landroid/graphics/PorterDuff$Mode;

    invoke-direct {p0, v1, v0}, Lw;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public final setAutoMirrored(Z)V
    ...
    invoke-static {v0, p1}, Lcd;->a(Landroid/graphics/drawable/Drawable;Z)V
...
.method public final setTintList(Landroid/content/res/ColorStateList;)V
    ...
    invoke-direct {p0, p1, v0}, Lw;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
...
.method public final setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-direct {p0, v0, p1}, Lw;->a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
