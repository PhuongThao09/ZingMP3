...
public class SwipeRefreshLayout extends ViewGroup
{
    ...
    public SwipeRefreshLayout(final Context context, final AttributeSet set) {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(final float n, final Transformation transformation) {
                ...
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((int)((n2 - SwipeRefreshLayout.this.mFrom) * n) + SwipeRefreshLayout.this.mFrom - SwipeRefreshLayout.this.mCircleView.getTop(), false);
    ...
    public void setSize(final int n) {
        ...
        final DisplayMetrics displayMetrics = this.getResources().getDisplayMetrics();
        if (n == 0) {
            final int n2 = (int)(displayMetrics.density * 56.0f);
            this.mCircleWidth = n2;
            this.mCircleHeight = n2;
        }
        else {
            final int n3 = (int)(displayMetrics.density * 40.0f);
