...
# static fields
.field private static kI:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;
...
.field private static ku:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.field private kB:Landroid/app/PendingIntent;

.field private kC:Lcom/google/android/gms/cast/CastDevice;

.field private kD:Landroid/content/Context;

.field private kE:Landroid/content/ServiceConnection;

.field private kF:Lhr;

.field private kG:Z

.field private final kH:Lhr$a;

.field private final kJ:Landroid/os/IBinder;

.field private kv:Lcom/google/android/gms/common/api/GoogleApiClient;

.field private kw:Lcom/google/android/gms/cast/CastRemoteDisplay$CastRemoteDisplaySessionCallbacks;

.field private kx:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$Callbacks;

.field private ky:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$zzb;

.field private kz:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$NotificationSettings;

.field private mHandler:Landroid/os/Handler;

.field private mNotification:Landroid/app/Notification;

.field private zzbzd:Landroid/view/Display;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kr:Lcom/google/android/gms/cast/internal/zzm;

    invoke-static {}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzajl()I

    move-result v0

    sput v0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->ks:I

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kt:Ljava/lang/Object;
    ...
    sput-object v0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->ku:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kG:Z
    ...
    iput-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kH:Lhr$a;
    ...
    iput-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kJ:Landroid/os/IBinder;
...
.method public static getInstance()Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;
    ...
    sget-object v1, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kt:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kI:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;
...
.method protected static setDebugEnabled()V
    ...
    sget-object v0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kr:Lcom/google/android/gms/cast/internal/zzm;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/google/android/gms/cast/internal/zzm;->zzbp(Z)V
...
.method public static startServiceWithOptions(Landroid/content/Context;Ljava/lang/Class;Ljava/lang/String;Lcom/google/android/gms/cast/CastDevice;Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$Options;Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$NotificationSettings;Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$Callbacks;)V
    ...
    const-string/jumbo v2, "An existing service had not been stopped before starting one"
    ...
    invoke-static {v0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzbg(Z)V
    ...
    const-string/jumbo v0, "activityContext is required."
    ...
    const-string/jumbo v0, "serviceClass is required."

    invoke-static {p1, v0}, Lcom/google/android/gms/common/internal/zzac;->zzb(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "applicationId is required."

    invoke-static {p2, v0}, Lcom/google/android/gms/common/internal/zzac;->zzb(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string/jumbo v0, "device is required."
    ...
    const-string/jumbo v0, "options is required."
    ...
    const-string/jumbo v0, "notificationSettings is required."
    ...
    const-string/jumbo v0, "callbacks is required."
    ...
    const-string/jumbo v1, "notificationSettings: Either the notification or the notificationPendingIntent must be provided"
    ...
    :cond_1
    sget-object v0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->ku:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    const-string/jumbo v1, "Service is already being started, startService has been called twice"
...
.method static synthetic zza(Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;Landroid/content/Context;)Landroid/content/Context;
    ...
    iput-object p1, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kD:Landroid/content/Context;
...
.method static synthetic zza(Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;Landroid/content/ServiceConnection;)Landroid/content/ServiceConnection;
    ...
    iput-object p1, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kE:Landroid/content/ServiceConnection;
...
.method static synthetic zza(Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;)Lcom/google/android/gms/cast/CastDevice;
    ...
    iget-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kC:Lcom/google/android/gms/cast/CastDevice;
...
.method private zza(Lcom/google/android/gms/cast/CastDevice;Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$Options;)Lcom/google/android/gms/common/api/GoogleApiClient;
    ...
    iget-object v1, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kw:Lcom/google/android/gms/cast/CastRemoteDisplay$CastRemoteDisplaySessionCallbacks;
    ...
    iget v1, p2, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$Options;->ko:I
...
.method private static zza(Landroid/content/Context;Ljava/lang/Class;)V
    ...
    const-string/jumbo v1, "The service must not be exported, verify the manifest configuration"
    ...
    const-string/jumbo v1, "Service not found, did you forget to configure it in the manifest?"
...
.method private zza(Landroid/view/Display;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzbzd:Landroid/view/Display;

    iget-boolean v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kA:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x1

    invoke-direct {p0, v0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzbh(Z)Landroid/app/Notification;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->mNotification:Landroid/app/Notification;

    sget v0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->ks:I
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kx:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$Callbacks;
    ...
    iput-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kx:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$Callbacks;

    :cond_1
    iget-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzbzd:Landroid/view/Display;
...
.method private zza(Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$NotificationSettings;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kz:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$NotificationSettings;

    if-nez v0, :cond_0

    new-instance v0, Ljava/lang/IllegalStateException;

    const-string/jumbo v1, "No current notification settings to update"
    ...
    const-string/jumbo v1, "Current mode is default notification, notification attribute must not be provided"
    ...
    const-string/jumbo v1, "notification is required."
...
.method static synthetic zza(Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzeq(Ljava/lang/String;)V
...
.method static synthetic zza(Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;Z)V
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzbf(Z)V
...
.method private zza(Ljava/lang/String;Lcom/google/android/gms/cast/CastDevice;Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$Options;Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$NotificationSettings;Landroid/content/Context;Landroid/content/ServiceConnection;Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$Callbacks;)Z
    ...
    const-string/jumbo v2, "startRemoteDisplaySession"

    invoke-direct {p0, v2}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzeq(Ljava/lang/String;)V

    const-string/jumbo v2, "Starting the Cast Remote Display must be done on the main thread"

    invoke-static {v2}, Lcom/google/android/gms/common/internal/zzac;->zzhq(Ljava/lang/String;)V

    sget-object v2, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kt:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    sget-object v3, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kI:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;

    if-eqz v3, :cond_0

    sget-object v1, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kr:Lcom/google/android/gms/cast/internal/zzm;

    const-string/jumbo v3, "An existing service had not been stopped before starting one"
    ...
    :cond_0
    sput-object p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kI:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;

    monitor-exit v2
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iput-object p7, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kx:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$Callbacks;

    iput-object p1, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->jM:Ljava/lang/String;

    iput-object p2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kC:Lcom/google/android/gms/cast/CastDevice;

    iput-object p5, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kD:Landroid/content/Context;

    iput-object p6, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kE:Landroid/content/ServiceConnection;
    ...
    invoke-static {v2}, Lhr;->a(Landroid/content/Context;)Lhr;

    move-result-object v2

    iput-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kF:Lhr;

    new-instance v2, Lhq$a;

    invoke-direct {v2}, Lhq$a;-><init>()V

    iget-object v3, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->jM:Ljava/lang/String;
    ...
    invoke-virtual {v2, v3}, Lhq$a;->a(Ljava/lang/String;)Lhq$a;
    ...
    const-string/jumbo v3, "addMediaRouterCallback"

    invoke-direct {p0, v3}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzeq(Ljava/lang/String;)V

    iget-object v3, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kF:Lhr;

    iget-object v4, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kH:Lhr$a;

    const/4 v5, 0x4

    invoke-virtual {v3, v2, v4, v5}, Lhr;->a(Lhq;Lhr$a;I)V
    ...
    iput-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kw:Lcom/google/android/gms/cast/CastRemoteDisplay$CastRemoteDisplaySessionCallbacks;
    ...
    iput-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->ky:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$zzb;

    iget-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->ky:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$zzb;

    new-instance v3, Landroid/content/IntentFilter;

    const-string/jumbo v4, "com.google.android.gms.cast.remote_display.ACTION_NOTIFICATION_DISCONNECT"
    ...
    iput-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kz:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$NotificationSettings;

    iget-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kz:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$NotificationSettings;
    ...
    iput-boolean v1, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kA:Z
    ...
    iput-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kv:Lcom/google/android/gms/common/api/GoogleApiClient;

    iget-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kv:Lcom/google/android/gms/common/api/GoogleApiClient;
    ...
    :cond_2
    iput-boolean v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kA:Z
...
.method private zzajm()V
    .locals 2

    iget-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kF:Lhr;

    if-eqz v0, :cond_0

    const-string/jumbo v0, "CastRemoteDisplayLocalService calls must be done on the main thread"

    invoke-static {v0}, Lcom/google/android/gms/common/internal/zzac;->zzhq(Ljava/lang/String;)V

    const-string/jumbo v0, "removeMediaRouterCallback"

    invoke-direct {p0, v0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzeq(Ljava/lang/String;)V

    iget-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kF:Lhr;

    iget-object v1, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kH:Lhr$a;
...
.method private zzajn()V
    .locals 3

    const-string/jumbo v0, "startRemoteDisplay"
    ...
    const-string/jumbo v1, "Unable to start the remote display as the API client is not ready"
    ...
    iget-object v1, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kv:Lcom/google/android/gms/common/api/GoogleApiClient;

    iget-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->jM:Ljava/lang/String;
...
.method private zzajo()V
    .locals 3

    const-string/jumbo v0, "stopRemoteDisplay"
    ...
    const-string/jumbo v1, "Unable to stop the remote display as the API client is not ready"
...
.method private zzajq()V
    .locals 1

    const-string/jumbo v0, "stopRemoteDisplaySession"

    invoke-direct {p0, v0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzeq(Ljava/lang/String;)V

    invoke-direct {p0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzajo()V
...
.method private zzajr()V
    .locals 1

    const-string/jumbo v0, "Stopping the remote display Service"
...
.method private zzajs()Landroid/app/PendingIntent;
    .locals 3

    iget-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kB:Landroid/app/PendingIntent;
    ...
    iget-object v1, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kD:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kB:Landroid/app/PendingIntent;
...
.method static synthetic zzajt()Lcom/google/android/gms/cast/internal/zzm;
    .locals 1
...
.method static synthetic zzaju()Ljava/util/concurrent/atomic/AtomicBoolean;
    .locals 1
...
.method static synthetic zzajv()Ljava/lang/Object;
    .locals 1

    sget-object v0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kt:Ljava/lang/Object;

    return-object v0
.end method

.method static synthetic zzajw()Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;
    .locals 1
...
.method static synthetic zzb(Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzet(Ljava/lang/String;)V
...
.method static synthetic zzb(Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;)Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kG:Z

    return v0
.end method

.method private zzbe(Z)V
    .locals 2
...
.method private zzbf(Z)V
    .locals 3

    const/4 v2, 0x0

    const-string/jumbo v0, "Stopping Service"
    ...
    const-string/jumbo v0, "Setting default route"

    invoke-direct {p0, v0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzeq(Ljava/lang/String;)V

    invoke-static {}, Lhr;->b()Lhr$g;

    move-result-object v0

    invoke-static {v0}, Lhr;->a(Lhr$g;)V

    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->ky:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$zzb;

    if-eqz v0, :cond_1

    const-string/jumbo v0, "Unregistering notification receiver"
    ...
    :cond_1
    invoke-direct {p0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzajq()V

    invoke-direct {p0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzajr()V

    invoke-direct {p0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzajm()V
    ...
    iput-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kv:Lcom/google/android/gms/common/api/GoogleApiClient;

    :cond_2
    iget-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kD:Landroid/content/Context;

    if-eqz v0, :cond_3

    iget-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kE:Landroid/content/ServiceConnection;
    ...
    iget-object v1, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kE:Landroid/content/ServiceConnection;
    ...
    :goto_0
    iput-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kE:Landroid/content/ServiceConnection;

    iput-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kD:Landroid/content/Context;

    :cond_3
    iput-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->jM:Ljava/lang/String;

    iput-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kv:Lcom/google/android/gms/common/api/GoogleApiClient;

    iput-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->mNotification:Landroid/app/Notification;

    iput-object v2, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzbzd:Landroid/view/Display;
    ...
    const-string/jumbo v0, "No need to unbind service, already unbound"
...
.method private static zzbg(Z)V
    .locals 4
    ...
    const-string/jumbo v1, "Stopping Service"
    ...
    const-string/jumbo v2, "Service is already being stopped"
    ...
    sput-object v2, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kI:Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;

    monitor-exit v1
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-direct {v0, p0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzbe(Z)V
...
.method private zzbh(Z)Landroid/app/Notification;
    .locals 7

    const/4 v6, 0x1

    const-string/jumbo v0, "createDefaultNotification"
    ...
    iget-object v5, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kC:Lcom/google/android/gms/cast/CastDevice;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzajs()Landroid/app/PendingIntent;
...
.method static synthetic zzbi(Z)V
    .locals 0

    invoke-static {p0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzbg(Z)V
...
.method static synthetic zzc(Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;)V
    ...
    invoke-direct {p0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzajp()V
...
.method private zzeq(Ljava/lang/String;)V
    ...
    const-string/jumbo v1, "[Instance: %s] %s"
...
.method private zzet(Ljava/lang/String;)V
    .locals 4
...
.method static synthetic zzf(Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;)V
    ...
    invoke-direct {p0}, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->zzajn()V
...
.method public onBind(Landroid/content/Intent;)Landroid/os/IBinder;
    ...
    iget-object v0, p0, Lcom/google/android/gms/cast/CastRemoteDisplayLocalService;->kJ:Landroid/os/IBinder;
...
.method public updateNotificationSettings(Lcom/google/android/gms/cast/CastRemoteDisplayLocalService$NotificationSettings;)V
    ...
    const-string/jumbo v1, "Service is not ready yet."
