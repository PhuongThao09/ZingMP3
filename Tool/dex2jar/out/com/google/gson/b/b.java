...
public final class b
{
    ...
    static Type b(final Type type, final Class<?> clazz, final Class<?> clazz2) {
        com.google.gson.b.a.a(clazz2.isAssignableFrom(clazz));
    ...
    public static Type d(final Type type) {
        if (type instanceof Class) {
            ...
            if (((Class)s).isArray()) {
                s = new a(d(((Class)s).getComponentType()));
            }
            return (Class<?>)s;
        }
        if (type instanceof ParameterizedType) {
    ...
    public static Class<?> e(Type rawType) {
        ...
        if (rawType instanceof ParameterizedType) {
            ...
            com.google.gson.b.a.a(rawType instanceof Class);
            return (Class<?>)rawType;
        }
    ...
    private static void i(final Type type) {
        com.google.gson.b.a.a(!(type instanceof Class) || !((Class)type).isPrimitive());
    }
    ...
    private static final class b implements Serializable, ParameterizedType
    {
        ...
        public b(Type d, final Type type, final Type... array) {
            ...
            if (type instanceof Class) {
                ...
                com.google.gson.b.a.a(d != null || b);
            }
            if (d == null) {
                d = null;
            }
            else {
                d = com.google.gson.b.b.d(d);
            }
            this.a = d;
            this.b = com.google.gson.b.b.d(type);
            this.c = array.clone();
            for (int i = n; i < this.c.length; ++i) {
                com.google.gson.b.a.a(this.c[i]);
                i(this.c[i]);
                this.c[i] = com.google.gson.b.b.d(this.c[i]);
            }
        }
        
        @Override
        public boolean equals(final Object o) {
            return o instanceof ParameterizedType && com.google.gson.b.b.a(this, (Type)o);
        }
        ...
        public String toString() {
            ...
            sb.append(com.google.gson.b.b.f(this.b));
            if (this.c.length == 0) {
                return sb.toString();
            }
            sb.append("<").append(com.google.gson.b.b.f(this.c[0]));
            for (int i = 1; i < this.c.length; ++i) {
                sb.append(", ").append(com.google.gson.b.b.f(this.c[i]));
            }
    ...
    private static final class c implements Serializable, WildcardType
    {
        ...
        public c(final Type[] array, final Type[] array2) {
            final boolean b = true;
            com.google.gson.b.a.a(array2.length <= 1);
            com.google.gson.b.a.a(array.length == 1);
            if (array2.length == 1) {
                com.google.gson.b.a.a(array2[0]);
                i(array2[0]);
                com.google.gson.b.a.a(array[0] == Object.class && b);
                this.b = com.google.gson.b.b.d(array2[0]);
                this.a = Object.class;
                return;
            }
            com.google.gson.b.a.a(array[0]);
            i(array[0]);
            this.b = null;
            this.a = com.google.gson.b.b.d(array[0]);
        }
        
        @Override
        public boolean equals(final Object o) {
            return o instanceof WildcardType && com.google.gson.b.b.a(this, (Type)o);
        }
        ...
        public String toString() {
            if (this.b != null) {
                return "? super " + com.google.gson.b.b.f(this.b);
            }
            if (this.a == Object.class) {
                return "?";
            }
            return "? extends " + com.google.gson.b.b.f(this.a);
        }
    }
}
