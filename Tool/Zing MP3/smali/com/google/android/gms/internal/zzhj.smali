...
.method public constructor <init>(Lcom/google/android/gms/internal/zzlt;Ljava/util/Map;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/internal/zzhj;->zzbiq:Ljava/util/Map;

    invoke-interface {p1}, Lcom/google/android/gms/internal/zzlt;->zzvn()Landroid/app/Activity;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/internal/zzhj;->mContext:Landroid/content/Context;

    return-void
.end method

.method static synthetic zza(Lcom/google/android/gms/internal/zzhj;)Landroid/content/Context;
    .locals 1
...
.method public execute()V
    ...
    invoke-virtual {p0, v0}, Lcom/google/android/gms/internal/zzhj;->zzbx(Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/internal/zzhj;->mContext:Landroid/content/Context;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/internal/zzda;->zzkl()Z
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/android/gms/internal/zzhj;->zzbiq:Ljava/util/Map;
    ...
    :cond_4
    invoke-virtual {p0, v0}, Lcom/google/android/gms/internal/zzhj;->zzbw(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v1, v2}, Lcom/google/android/gms/internal/zzkr;->zzcx(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/internal/zzkh;->getResources()Landroid/content/res/Resources;
    ...
    iget-object v4, p0, Lcom/google/android/gms/internal/zzhj;->mContext:Landroid/content/Context;

    invoke-virtual {v1, v4}, Lcom/google/android/gms/internal/zzkr;->zzaf(Landroid/content/Context;)Landroid/app/AlertDialog$Builder;
    ...
    :goto_5
    new-instance v5, Lcom/google/android/gms/internal/zzhj$1;

    invoke-direct {v5, p0, v0, v2}, Lcom/google/android/gms/internal/zzhj$1;-><init>(Lcom/google/android/gms/internal/zzhj;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_6
    new-instance v1, Lcom/google/android/gms/internal/zzhj$2;

    invoke-direct {v1, p0}, Lcom/google/android/gms/internal/zzhj$2;-><init>(Lcom/google/android/gms/internal/zzhj;)V
...
.method zzbw(Ljava/lang/String;)Ljava/lang/String;
    .locals 1
...
.method zzk(Ljava/lang/String;Ljava/lang/String;)Landroid/app/DownloadManager$Request;
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/gms/internal/zzks;->zza(Landroid/app/DownloadManager$Request;)Z
