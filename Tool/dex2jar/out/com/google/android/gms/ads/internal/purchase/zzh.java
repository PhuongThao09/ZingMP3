...
public class zzh
{
    ...
    static {
        a = String.format(Locale.US, "CREATE TABLE IF NOT EXISTS %s ( %s INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, %s TEXT NOT NULL, %s TEXT NOT NULL, %s INTEGER)", "InAppPurchase", "purchase_id", "product_id", "developer_payload", "record_time");
        c = new Object();
    }
    ...
    public static zzh zzy(final Context context) {
        synchronized (zzh.c) {
            if (zzh.d == null) {
                zzh.d = new zzh(context);
            }
            return zzh.d;
        }
    }
    ...
    public int getRecordCount() {
        ...
        //     2: aconst_null    
        //     3: astore_2       
        //     4: getstatic       com/google/android/gms/ads/internal/purchase/zzh.c:Ljava/lang/Object;
        //     7: astore          5
        //     9: aload           5
        //    11: monitorenter   
        //    12: aload_0        
    ...
    public void zza(final zzf zzf) {
        ...
        final zzf zzf2;
        writableDatabase.delete("InAppPurchase", String.format(Locale.US, "%s = %d", "purchase_id", zzf2.zzEO), (String[])null);
    }
    // monitorexit(o)
    ...
    public void zzb(final zzf zzf) {
        ...
        final zzf zzf2;
        contentValues.put("product_id", zzf2.zzEQ);
        contentValues.put("developer_payload", zzf2.zzEP);
        contentValues.put("record_time", SystemClock.elapsedRealtime());
        zzf2.zzEO = writableDatabase.insert("InAppPurchase", (String)null, contentValues);
    ...
    public void zzfL() {
        ...
        // Original Bytecode:
        // 
        //     0: getstatic       com/google/android/gms/ads/internal/purchase/zzh.c:Ljava/lang/Object;
        //     3: astore          4
        //     5: aload           4
        //     7: monitorenter   
        //     8: aload_0        
    ...
    public List<zzf> zzg(final long p0) {
        ...
        //    28: areturn        
        //    29: aload_0        
        //    30: invokevirtual   com/google/android/gms/ads/internal/purchase/zzh.getWritableDatabase:()Landroid/database/sqlite/SQLiteDatabase;
        //    33: astore          4
        //    35: aload           4
        //    37: ifnonnull       46
        //    40: aload           7
        ...
        //   164: invokestatic    com/google/android/gms/ads/internal/util/client/zzb.zzaH:(Ljava/lang/String;)V
        //   167: aload           5
        //   169: ifnull          126
        //   172: aload           5
