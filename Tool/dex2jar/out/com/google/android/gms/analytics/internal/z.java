...
public class z extends p
{
    ...
    private boolean a(final Context context, final String s) {
        ...
        try {
            ...
            try {
                ...
                this.e("Failed to close clientId writing stream", ex);
                return true;
            }
        }
        catch (FileNotFoundException ex2) {
            fileOutputStream5 = openFileOutput;
            this.e("Error creating clientId file", ex2);
            ...
            try {
                ...
                this.e("Failed to close clientId writing stream", ex3);
                return false;
            }
        }
        catch (IOException ex4) {
            fileOutputStream5 = fileOutputStream4;
            this.e("Error writing to clientId file", ex4);
            ...
            try {
                ...
                this.e("Failed to close clientId writing stream", ex5);
                return false;
            }
        }
        finally {
            Label_0185: {
                ...
                try {
                    ...
                    this.e("Failed to close clientId writing stream", ex6);
                }
            }
        }
    }
    ...
    private String f() {
        String e = this.e();
        try {
            if (!this.a(this.r().c(), e)) {
                e = "0";
            }
            return e;
        }
        catch (Exception ex) {
            this.e("Error saving clientId file", ex);
            return "0";
        }
    }
    
    protected String a(final Context p0) {
        // 
        ...
        //    51: invokevirtual   com/google/android/gms/analytics/internal/z.e:(Ljava/lang/String;)V
        //    54: aload_3        
        //    55: astore          4
        //    57: aload_3        
        ...
        //    85: aload_1        
        //    86: invokevirtual   com/google/android/gms/analytics/internal/z.e:(Ljava/lang/String;Ljava/lang/Object;)V
        //    89: aconst_null    
        //    90: areturn        
        //    91: iload_2        
        //    92: bipush          14
        ...
        //   103: invokevirtual   com/google/android/gms/analytics/internal/z.e:(Ljava/lang/String;)V
        //   106: aload_3        
        //   107: astore          4
        //   109: aload_3        
        ...
        //   137: aload_1        
        //   138: invokevirtual   com/google/android/gms/analytics/internal/z.e:(Ljava/lang/String;Ljava/lang/Object;)V
        //   141: aconst_null    
        //   142: areturn        
        //   143: aload_3        
        //   144: astore          4
        ...
        //   172: aload           5
        //   174: invokevirtual   com/google/android/gms/analytics/internal/z.a:(Ljava/lang/String;Ljava/lang/Object;)V
        //   177: aload_3        
        //   178: ifnull          185
        //   181: aload_3        
        ...
        //   192: aload_1        
        //   193: invokevirtual   com/google/android/gms/analytics/internal/z.e:(Ljava/lang/String;Ljava/lang/Object;)V
        //   196: goto            185
        //   199: astore_1       
        //   200: aconst_null    
        //   201: astore_1       
        ...
        //   216: aload_1        
        //   217: invokevirtual   com/google/android/gms/analytics/internal/z.e:(Ljava/lang/String;Ljava/lang/Object;)V
        //   220: aconst_null    
        //   221: areturn        
        //   222: astore          5
        //   224: aconst_null    
        ...
        //   232: aload           5
        //   234: invokevirtual   com/google/android/gms/analytics/internal/z.e:(Ljava/lang/String;Ljava/lang/Object;)V
        //   237: aload_3        
        //   238: astore          4
        //   240: aload_1        
        //   241: ldc             "gaClientId"
        ...
        //   261: aload_1        
        //   262: invokevirtual   com/google/android/gms/analytics/internal/z.e:(Ljava/lang/String;Ljava/lang/Object;)V
        //   265: aconst_null    
        //   266: areturn        
        //   267: astore_1       
        //   268: aconst_null    
        ...
        //   287: aload_3        
        //   288: invokevirtual   com/google/android/gms/analytics/internal/z.e:(Ljava/lang/String;Ljava/lang/Object;)V
        //   291: goto            281
        //   294: astore_1       
        //   295: goto            271
        //   298: astore          5
    ...
    public String b() {
        ...
        try {
            if (this.a == null) {
                this.b = this.r().a((Callable<String>)new Callable<String>() {
            ...
            Label_0085: {
                ...
                try {
                    ...
                    this.d("ClientId loading or generation was interrupted", ex);
                    this.a = "0";
                }
                catch (ExecutionException ex2) {
                    this.e("Failed to load or generate client id", ex2);
                    this.a = "0";
                }
            }
        }
