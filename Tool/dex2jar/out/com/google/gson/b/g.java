...
public final class g<K, V> extends AbstractMap<K, V> implements Serializable
{
    ...
    public g() {
        this((Comparator)com.google.gson.b.g.g);
    }
    ...
    private void a(final d<K, V> d, final d<K, V> c) {
        ...
        if (!com.google.gson.b.g.f && a.c != d) {
    ...
    private void b(d<K, V> a, final boolean b) {
        while (a != null) {
            ...
            if (n == -2) {
                ...
                if (!com.google.gson.b.g.f && n != -1 && n != 1) {
                    throw new AssertionError();
                }
                a.h = Math.max(h, h2) + 1;
                if (!b) {
    ...
    d<K, V> a(final K k, final boolean b) {
        ...
        if (b) {
            ...
            d c;
            if (b2 == null) {
                if (a == com.google.gson.b.g.g && !(k instanceof Comparable)) {
    ...
    class a extends AbstractSet<Entry<K, V>>
    {
        @Override
        public void clear() {
            com.google.gson.b.g.this.clear();
        }
        
        @Override
        public boolean contains(final Object o) {
            return o instanceof Entry && com.google.gson.b.g.this.a((Entry<?, ?>)o) != null;
        }
        ...
        public boolean remove(final Object o) {
            if (o instanceof Entry) {
                final d<K, V> a = com.google.gson.b.g.this.a((Entry<?, ?>)o);
                if (a != null) {
                    com.google.gson.b.g.this.a(a, true);
                    return true;
                }
            }
            return false;
        ...
        @Override
        public int size() {
            return com.google.gson.b.g.this.c;
        }
    }
    ...
    final class b extends AbstractSet<K>
    {
        ...
        @Override
        public boolean contains(final Object o) {
            return com.google.gson.b.g.this.containsKey(o);
        }
        ...
        @Override
        public boolean remove(final Object o) {
            return com.google.gson.b.g.this.b(o) != null;
        }
    ...
    private abstract class c<T> implements Iterator<T>
    {
        ...
        private c() {
            this.b = com.google.gson.b.g.this.e.d;
            this.c = null;
            this.d = com.google.gson.b.g.this.d;
        }
        
        final d<K, V> b() {
            final d<K, V> b = this.b;
            if (b == com.google.gson.b.g.this.e) {
                throw new NoSuchElementException();
            }
            if (com.google.gson.b.g.this.d != this.d) {
        ...
        public final boolean hasNext() {
            return this.b != com.google.gson.b.g.this.e;
        }
        ...
        public final void remove() {
            ...
            com.google.gson.b.g.this.a(this.c, true);
            this.c = null;
            this.d = com.google.gson.b.g.this.d;
        }
    }
