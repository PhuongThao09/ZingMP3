...
.method createBorderDrawable(ILandroid/content/res/ColorStateList;)Landroid/support/design/widget/CircularBorderDrawable;
    ...
    .line 154
    sget v2, Li$c;->design_fab_stroke_top_outer_color:I

    .line 155
    invoke-static {v0, v2}, Lbt;->getColor(Landroid/content/Context;I)I

    move-result v2

    sget v3, Li$c;->design_fab_stroke_top_inner_color:I

    .line 156
    invoke-static {v0, v3}, Lbt;->getColor(Landroid/content/Context;I)I

    move-result v3

    sget v4, Li$c;->design_fab_stroke_end_inner_color:I

    .line 157
    invoke-static {v0, v4}, Lbt;->getColor(Landroid/content/Context;I)I

    move-result v4

    sget v5, Li$c;->design_fab_stroke_end_outer_color:I

    .line 158
    invoke-static {v0, v5}, Lbt;->getColor(Landroid/content/Context;I)I
