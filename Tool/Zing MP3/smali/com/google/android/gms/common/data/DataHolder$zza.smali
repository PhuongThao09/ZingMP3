...
.field private final zW:Ljava/util/ArrayList;
...
.field private final zY:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.method private constructor <init>([Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/data/DataHolder$zza;->zO:[Ljava/lang/String;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/data/DataHolder$zza;->zW:Ljava/util/ArrayList;

    iput-object p2, p0, Lcom/google/android/gms/common/data/DataHolder$zza;->zX:Ljava/lang/String;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/data/DataHolder$zza;->zY:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lcom/google/android/gms/common/data/DataHolder$zza;->zZ:Z

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/gms/common/data/DataHolder$zza;->Aa:Ljava/lang/String;
...
.method static synthetic zza(Lcom/google/android/gms/common/data/DataHolder$zza;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/data/DataHolder$zza;->zO:[Ljava/lang/String;
...
.method static synthetic zzb(Lcom/google/android/gms/common/data/DataHolder$zza;)Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/data/DataHolder$zza;->zW:Ljava/util/ArrayList;
...
.method private zzc(Ljava/util/HashMap;)I
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/data/DataHolder$zza;->zX:Ljava/lang/String;
    ...
    :cond_1
    iget-object v0, p0, Lcom/google/android/gms/common/data/DataHolder$zza;->zY:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Lcom/google/android/gms/common/data/DataHolder$zza;->zW:Ljava/util/ArrayList;
...
.method public zzb(Ljava/util/HashMap;)Lcom/google/android/gms/common/data/DataHolder$zza;
    ...
    :cond_0
    iget-object v1, p0, Lcom/google/android/gms/common/data/DataHolder$zza;->zW:Ljava/util/ArrayList;
