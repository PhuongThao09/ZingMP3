...
.field public static final c:Lqt;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lqt;->d:Ljava/util/Set;
    ...
    sput-object v0, Lqt;->e:Ljava/util/Queue;

    .line 38
    new-instance v0, Lqt$1;

    invoke-direct {v0}, Lqt$1;-><init>()V
    ...
    invoke-direct {v0}, Lqt$2;-><init>()V

    sput-object v0, Lqt;->b:Lqt;

    .line 72
    new-instance v0, Lqt$3;

    invoke-direct {v0}, Lqt$3;-><init>()V
...
.method private static a(Ljava/io/InputStream;Lnh;)Landroid/graphics/Bitmap$Config;
    .locals 4
    ...
    const-string/jumbo v2, "Cannot determine whether the image has alpha or not from header for format "
...
.method private static a(Luj;Lrb;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 3
    ...
    invoke-virtual {p0, v0}, Luj;->mark(I)V
    ...
    const-string/jumbo v2, "Exception loading inDecodeBounds="
...
.method private static a(Landroid/graphics/BitmapFactory$Options;)V
    ...
    .prologue
    .line 367
    invoke-static {p0}, Lqt;->b(Landroid/graphics/BitmapFactory$Options;)V

    .line 368
    sget-object v1, Lqt;->e:Ljava/util/Queue;

    monitor-enter v1

    .line 369
    :try_start_0
    sget-object v0, Lqt;->e:Ljava/util/Queue;
...
.method private static a(Ljava/io/InputStream;)Z
    ...
    .line 234
    sget-object v1, Lqt;->d:Ljava/util/Set;
...
.method private static declared-synchronized b()Landroid/graphics/BitmapFactory$Options;
    ...
    :try_start_0
    sget-object v2, Lqt;->e:Ljava/util/Queue;
    ...
    .line 360
    invoke-static {v0}, Lqt;->b(Landroid/graphics/BitmapFactory$Options;)V
    :try_end_2
...
.method public final a(Ljava/io/InputStream;Lol;IILnh;)Landroid/graphics/Bitmap;
    .locals 20
    ...
    .line 111
    invoke-static {}, Lqt;->b()Landroid/graphics/BitmapFactory$Options;
    ...
    invoke-direct {v12, v0, v10}, Lrb;-><init>(Ljava/io/InputStream;[B)V

    .line 119
    invoke-static {v12}, Lug;->a(Ljava/io/InputStream;)Lug;
    ...
    invoke-direct {v14, v13}, Luj;-><init>(Ljava/io/InputStream;)V

    .line 126
    const/high16 v4, 0x500000

    :try_start_0
    invoke-virtual {v13, v4}, Lug;->mark(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :goto_3
    :try_start_2
    invoke-virtual {v13}, Lug;->reset()V
    :try_end_2
    ...
    .line 1308
    invoke-static {v14, v12, v11}, Lqt;->a(Luj;Lrb;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual {v0, v6, v5, v1, v2}, Lqt;->a(IIII)I
    ...
    invoke-static {v14, v0}, Lqt;->a(Ljava/io/InputStream;Lnh;)Landroid/graphics/Bitmap$Config;
    ...
    :cond_5
    invoke-static {v14}, Lqt;->a(Ljava/io/InputStream;)Z
    ...
    invoke-interface {v0, v5, v4, v15}, Lol;->b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 4122
    iget-object v4, v13, Lug;->a:Ljava/io/IOException;
    ...
    invoke-virtual {v8, v9}, Lue;->a([B)Z

    .line 177
    invoke-virtual {v8, v10}, Lue;->a([B)Z

    .line 178
    invoke-virtual {v13}, Lug;->a()V

    .line 179
    invoke-static {v11}, Lqt;->a(Landroid/graphics/BitmapFactory$Options;)V
    ...
    const-string/jumbo v16, "Unable to read segment data, type: "
    ...
    const-string/jumbo v7, ", actually read: "
    ...
    invoke-virtual {v0, v5, v6, v1, v2}, Lqt;->a(IIII)I
    ...
    invoke-interface {v0, v5}, Lol;->a(Landroid/graphics/Bitmap;)Z
    ...
    .line 4269
    invoke-static {v5}, Lre;->a(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;
    ...
    invoke-interface {v0, v12, v14, v15}, Lol;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
