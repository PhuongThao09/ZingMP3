...
public class ViewPager extends ViewGroup
{
    ...
    private void calculatePageOffsets(ItemInfo itemInfo, int i, ItemInfo itemInfo2) {
        ...
        if (itemInfo2 != null) {
            ...
            if (position < itemInfo.position) {
                ...
                int j;
                for (int n3 = position + 1, n4 = 0; n3 <= itemInfo.position && n4 < this.mItems.size(); n3 = j + 1) {
        ...
        i = n10;
        while (n11 < size) {
            for (itemInfo = this.mItems.get(n11); i < itemInfo.position; ++i) {
    ...
    private ItemInfo infoForCurrentScrollPosition() {
        ...
        while (true) {
            ...
            ItemInfo mTempItem = this.mItems.get(n3);
                ...
                if (!layoutParams2.isDecor) {
                    ...
                    if (infoForChild != null) {
                        ...
                        if (layoutParams2.needsMeasure) {
                            ...
                            child2.measure(View$MeasureSpec.makeMeasureSpec((int)(layoutParams2.widthFactor * n13), 1073741824), View$MeasureSpec.makeMeasureSpec(n2 - paddingTop - paddingBottom, 1073741824));
                        }
                            ...
                            if (addNewItem != null) {
                                ...
                                if (widthFactor < 2.0f) {
                                    ...
                                    for (int k = this.mCurItem + 1; k < count; ++k) {
                                        ...
                                        else if (itemInfo5 != null && k == itemInfo5.position) {
