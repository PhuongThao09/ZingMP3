...
.field final callFactory:Lbuh$a;

.field private final contentType:Lbux;

.field private final hasBody:Z

.field private final headers:Lbuu;
...
.method constructor <init>(Lretrofit2/ServiceMethod$Builder;)V
    ...
    invoke-virtual {v0}, Lretrofit2/Retrofit;->callFactory()Lbuh$a;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/ServiceMethod;->callFactory:Lbuh$a;
    ...
    invoke-virtual {v0}, Lretrofit2/Retrofit;->baseUrl()Lbuv;

    move-result-object v0

    iput-object v0, p0, Lretrofit2/ServiceMethod;->baseUrl:Lbuv;
    ...
    .line 85
    iget-object v0, p1, Lretrofit2/ServiceMethod$Builder;->headers:Lbuu;

    iput-object v0, p0, Lretrofit2/ServiceMethod;->headers:Lbuu;

    .line 86
    iget-object v0, p1, Lretrofit2/ServiceMethod$Builder;->contentType:Lbux;

    iput-object v0, p0, Lretrofit2/ServiceMethod;->contentType:Lbux;
...
# virtual methods
.method final varargs toRequest([Ljava/lang/Object;)Lbvc;
    .locals 10
    ...
    iget-object v2, p0, Lretrofit2/ServiceMethod;->baseUrl:Lbuv;

    iget-object v3, p0, Lretrofit2/ServiceMethod;->relativeUrl:Ljava/lang/String;

    iget-object v4, p0, Lretrofit2/ServiceMethod;->headers:Lbuu;

    iget-object v5, p0, Lretrofit2/ServiceMethod;->contentType:Lbux;
    ...
    invoke-direct/range {v0 .. v8}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lbuv;Ljava/lang/String;Lbuu;Lbux;ZZZ)V
    ...
    .line 111
    :cond_2
    invoke-virtual {v0}, Lretrofit2/RequestBuilder;->build()Lbvc;
...
.method final toResponse(Lbvf;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
