...
public class MenuBuilder implements SupportMenu
{
                ...
                while (true) {
                    while (iterator.hasNext()) {
                        ...
                        if (menuPresenter == null) {
                            ...
                            final boolean b2 = collapseItemActionView = menuPresenter.collapseItemActionView(this, menuItemImpl);
                            if (!b2) {
                                continue;
                            }
            ...
            while (true) {
                while (iterator.hasNext()) {
                    ...
                    if (menuPresenter == null) {
                        ...
                        final boolean b2 = expandItemActionView = menuPresenter.expandItemActionView(this, mExpandedItem);
                        if (!b2) {
                            continue;
                        }
    ...
    public MenuItem findItem(final int n) {
        for (int size = this.size(), i = 0; i < size; ++i) {
            ...
            if (((MenuItemImpl)item).getItemId() == n || (((MenuItemImpl)item).hasSubMenu() && (item = ((MenuItemImpl)item).getSubMenu().findItem(n)) != null)) {
    ...
    MenuItemImpl findItemWithShortcutForKey(final int n, final KeyEvent keyEvent) {
        ...
        if (mTempShortcutItemList.isEmpty()) {
            ...
            for (int i = 0; i < size; ++i) {
                final MenuItemImpl menuItemImpl2 = mTempShortcutItemList.get(i);
                char c;
                if (qwertyMode) {
        ...
        if (menuItemImpl != null) {
            if (!menuItemImpl.isEnabled()) {
                ...
                if (menuItemImpl.hasCollapsibleActionView()) {
                    final boolean b4 = b2 = (menuItemImpl.expandActionView() | invoke);
                    if (b4) {
                        this.close(true);
                        return b4;
                    }
                    ...
                    final boolean b5 = b2 = (this.dispatchSubMenuSelected(subMenuBuilder, menuPresenter) | invoke);
                    if (!b5) {
                        this.close(true);
                        return b5;
                    }
