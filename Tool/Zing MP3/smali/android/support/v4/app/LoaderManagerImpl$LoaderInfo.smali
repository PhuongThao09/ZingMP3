...
# virtual methods
.method final callOnLoadFinished(Lbv;Ljava/lang/Object;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2498
    invoke-static {p2, v2}, Ldy;->a(Ljava/lang/Object;Ljava/lang/StringBuilder;)V
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoadFinished(Lbv;Ljava/lang/Object;)V
    :try_end_0
...
.method final cancel()Z
    ...
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbv;
    ...
    invoke-virtual {p0, v0}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->onLoadCanceled(Lbv;)V
...
.method final destroy()V
    ...
    iget-object v1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbv;
    ...
    iget-object v3, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbv;

    invoke-interface {v0, v3}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onLoaderReset(Lbv;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v0, p0}, Lbv;->a(Lbv$b;)V

    .line 371
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbv;

    invoke-virtual {v0, p0}, Lbv;->a(Lbv$a;)V
    ...
    .line 2421
    iput-boolean v5, v0, Lbv;->f:Z

    .line 2422
    iput-boolean v4, v0, Lbv;->d:Z

    .line 2423
    iput-boolean v4, v0, Lbv;->e:Z

    .line 2424
    iput-boolean v4, v0, Lbv;->g:Z

    .line 2425
    iput-boolean v4, v0, Lbv;->h:Z
...
.method public final dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    iget-object v2, v0, Lbv;->b:Lbv$b;

    invoke-virtual {p3, v2}, Ljava/io/PrintWriter;->println(Ljava/lang/Object;)V

    .line 2524
    iget-boolean v2, v0, Lbv;->d:Z

    if-nez v2, :cond_0

    iget-boolean v2, v0, Lbv;->g:Z
    ...
    .line 2529
    :cond_1
    iget-boolean v2, v0, Lbv;->e:Z

    if-nez v2, :cond_2

    iget-boolean v2, v0, Lbv;->f:Z
...
.method final finishRetain()V
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Lbv;Ljava/lang/Object;)V
...
.method public final onLoadCanceled(Lbv;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Leg;

    iget v1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mId:I

    invoke-virtual {v0, v1}, Leg;->a(I)Ljava/lang/Object;
    ...
    iget-object v1, v1, Landroid/support/v4/app/LoaderManagerImpl;->mLoaders:Leg;

    iget v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mId:I

    invoke-virtual {v1, v2, v3}, Leg;->a(ILjava/lang/Object;)V
...
.method public final onLoadComplete(Lbv;Ljava/lang/Object;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 444
    invoke-virtual {p0, p1, p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->callOnLoadFinished(Lbv;Ljava/lang/Object;)V

    .line 454
    :cond_7
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->this$0:Landroid/support/v4/app/LoaderManagerImpl;

    iget-object v0, v0, Landroid/support/v4/app/LoaderManagerImpl;->mInactiveLoaders:Leg;
    ...
    invoke-virtual {v0, v1}, Leg;->b(I)V
...
.method final start()V
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v4/app/LoaderManager$LoaderCallbacks;->onCreateLoader(ILandroid/os/Bundle;)Lbv;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbv;
    ...
    iget-object v2, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLoader:Lbv;
    ...
    .line 1269
    iput-boolean v3, v0, Lbv;->d:Z

    .line 1270
    iput-boolean v4, v0, Lbv;->f:Z
