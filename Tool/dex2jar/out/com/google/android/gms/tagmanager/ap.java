...
class ap implements c
{
    ...
    public ap(final Context context) {
        this(context, kp.d(), "google_tagmanager.db", 2000, Executors.newSingleThreadExecutor());
    }
    
    ap(final Context c, final kn e, final String s, final int f, final Executor b) {
        this.c = c;
        this.e = e;
        this.f = f;
        this.b = b;
        this.d = new a(this.c, s);
    }
    ...
    private List<com.google.android.gms.tagmanager.c.a> a(final List<b> list) {
        final ArrayList<com.google.android.gms.tagmanager.c.a> list2 = new ArrayList<com.google.android.gms.tagmanager.c.a>();
        for (final b b : list) {
            list2.add(new com.google.android.gms.tagmanager.c.a(b.a, this.a(b.b)));
        }
        return list2;
    }
    ...
    private void a(int n) {
        ...
        if (n > 0) {
            ...
            m.c("DataLayer store full, deleting " + b.size() + " entries to make room.");
    ...
    private void a(final long n) {
        ...
        try {
            m.d("Deleted " + a.delete("datalayer", "expires <= ?", new String[] { Long.toString(n) }) + " expired items");
        }
        catch (SQLiteException ex) {
        ...
        if (array != null && array.length != 0) {
            ...
            if (a != null) {
                ...
                try {
                    ...
                    m.b("Error deleting entries " + Arrays.toString(array));
                }
            }
        }
    }
    ...
    private List<com.google.android.gms.tagmanager.c.a> b() {
        try {
            this.a(this.e.a());
    ...
    private List<String> b(final int p0) {
        // 
        // This method could not be decompiled.
        // 
        // Original Bytecode:
        ...
        //    16: invokestatic    com/google/android/gms/tagmanager/m.b:(Ljava/lang/String;)V
        //    19: aload           6
        //    21: areturn        
        //    22: aload_0        
        //    23: ldc_w           "Error opening database for peekEntryIds."
        //    26: invokespecial   com/google/android/gms/tagmanager/ap.a:(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
        //    29: astore_3       
        //    30: aload_3        
        //    31: ifnonnull       37
        //    34: aload           6
        ...
        //   182: invokestatic    com/google/android/gms/tagmanager/m.b:(Ljava/lang/String;)V
        //   185: aload           4
        //   187: ifnull          147
        //   190: aload           4
    ...
    private List<b> b(final List<com.google.android.gms.tagmanager.c.a> list) {
        final ArrayList<b> list2 = new ArrayList<b>();
        for (final com.google.android.gms.tagmanager.c.a a : list) {
            list2.add(new b(a.a, this.a(a.b)));
        }
        return list2;
    }
    ...
    private int d() {
        ...
        try {
            final Cursor cursor2 = cursor = (rawQuery = a.rawQuery("SELECT COUNT(*) from datalayer", (String[])null));
    ...
    @Override
    public void a(final List<com.google.android.gms.tagmanager.c.a> list, final long n) {
        this.b.execute(new Runnable() {
            final /* synthetic */ List a = ap.this.b(list);
    ...
    class a extends SQLiteOpenHelper
    {
        ...
        private boolean a(final String p0, final SQLiteDatabase p1) {
            ...
            //    73: invokestatic    com/google/android/gms/tagmanager/m.b:(Ljava/lang/String;)V
            //    76: aload_2        
            //    77: ifnull          86
            //    80: aload_2        
        ...
        public SQLiteDatabase getWritableDatabase() {
            ...
            while (true) {
                try {
                    ...
                    ap.this.c.getDatabasePath("google_tagmanager.db").delete();
                    continue;
                }
                break;
            }
        ...
        public void onCreate(final SQLiteDatabase sqLiteDatabase) {
            com.google.android.gms.tagmanager.h.a(sqLiteDatabase.getPath());
        }
