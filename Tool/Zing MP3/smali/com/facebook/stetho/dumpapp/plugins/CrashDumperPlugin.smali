...
.method private doKill(Lcom/facebook/stetho/dumpapp/DumperContext;Ljava/util/Iterator;)V
    ...
    const-string/jumbo v4, "/system/bin/kill"
    ...
    const-string/jumbo v3, "Failed to invoke kill: "
...
.method private doUncaughtException(Ljava/util/Iterator;)V
    ...
    const-string/jumbo v3, "Uncaught exception triggered by Stetho"
    ...
    const-string/jumbo v3, "Invalid supplied Throwable class: "
...
.method private doUsage(Ljava/io/PrintStream;)V
    ...
    .prologue
    .line 71
    const-string/jumbo v0, "Usage: dumpapp crash "
    ...
    .line 78
    const-string/jumbo v0, "dumpapp crash throw: Throw an uncaught exception (simulates a program crash)"

    invoke-virtual {p1, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 79
    const-string/jumbo v0, "    <Throwable>: Throwable class to use (default: java.lang.Error)"
    ...
    .line 81
    const-string/jumbo v0, "dumpapp crash kill: Send a signal to this process (simulates the low memory killer)"

    invoke-virtual {p1, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 82
    const-string/jumbo v0, "    <SIGNAL>: Either signal name or number to send (default: 9)"

    invoke-virtual {p1, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 83
    const-string/jumbo v0, "              See `adb shell kill -l` for more information"
    ...
    .line 85
    const-string/jumbo v0, "dumpapp crash exit: Invoke System.exit (simulates an abnormal Android exit strategy)"

    invoke-virtual {p1, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 86
    const-string/jumbo v0, "    <code>: Exit code (default: 0)"
