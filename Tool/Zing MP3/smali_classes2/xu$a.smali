...
.method public constructor <init>(Lcom/google/android/gms/ads/formats/NativeAppInstallAd;)V
    ...
    iput-object p1, p0, Lxu$a;->a:Lcom/google/android/gms/ads/formats/NativeAppInstallAd;
    ...
    invoke-virtual {p0, v0}, Lxu$a;->setHeadline(Ljava/lang/String;)V

    invoke-virtual {p1}, Lcom/google/android/gms/ads/formats/NativeAppInstallAd;->getImages()Ljava/util/List;

    move-result-object v0

    invoke-virtual {p0, v0}, Lxu$a;->setImages(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v0}, Lxu$a;->setBody(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lxu$a;->setIcon(Lcom/google/android/gms/ads/formats/NativeAd$Image;)V
    ...
    invoke-virtual {p0, v0}, Lxu$a;->setCallToAction(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v1}, Lxu$a;->setStarRating(D)V
    ...
    invoke-virtual {p0, v0}, Lxu$a;->setStore(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lxu$a;->setPrice(Ljava/lang/String;)V

    :cond_2
    invoke-virtual {p0, v2}, Lxu$a;->setOverrideImpressionRecording(Z)V

    invoke-virtual {p0, v2}, Lxu$a;->setOverrideClickHandling(Z)V
    ...
    invoke-virtual {p0, v0}, Lxu$a;->zza(Lcom/google/android/gms/ads/VideoController;)V
...
.method public final trackView(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lxu$a;->a:Lcom/google/android/gms/ads/formats/NativeAppInstallAd;
