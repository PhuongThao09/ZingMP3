...
public class ActionBarOverlayLayout extends ViewGroup implements NestedScrollingParent, DecorContentParent
{
    ...
    protected void onLayout(final boolean b, int i, final int n, int n2, final int n3) {
        ...
        for (i = 0; i < childCount; ++i) {
            ...
            if (child.getVisibility() != 8) {
                ...
                n4 = layoutParams.leftMargin + paddingLeft;
    ...
    protected void onMeasure(final int n, final int n2) {
        ...
        int n4 = Math.max(0, layoutParams.bottomMargin + (this.mActionBarTop.getMeasuredHeight() + layoutParams.topMargin));
        ...
        if (this.mActionBarBottom != null) {
            ...
            n4 = Math.max(n4, layoutParams2.bottomMargin + (this.mActionBarBottom.getMeasuredHeight() + layoutParams2.topMargin));
        ...
        final int max2 = Math.max(n4, layoutParams3.bottomMargin + (this.mContent.getMeasuredHeight() + layoutParams3.topMargin));
