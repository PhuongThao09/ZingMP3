...
.field private final hg:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hd:Lcom/google/android/gms/common/api/Scope;
    ...
    sput-object v0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->he:Lcom/google/android/gms/common/api/Scope;
    ...
    sput-object v0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hf:Lcom/google/android/gms/common/api/Scope;
    ...
    sput-object v0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hc:Ljava/util/Comparator;
...
.method constructor <init>(ILjava/util/ArrayList;Landroid/accounts/Account;ZZZLjava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hg:Ljava/util/ArrayList;

    iput-object p3, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->ec:Landroid/accounts/Account;

    iput-boolean p4, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hh:Z

    iput-boolean p5, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hi:Z

    iput-boolean p6, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hj:Z

    iput-object p7, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hk:Ljava/lang/String;

    iput-object p8, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hl:Ljava/lang/String;
...
.method private zzahi()Lorg/json/JSONObject;
    ...
    iget-object v0, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hg:Ljava/util/ArrayList;

    sget-object v3, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hc:Ljava/util/Comparator;
    ...
    iget-object v0, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->ec:Landroid/accounts/Account;

    if-eqz v0, :cond_1

    const-string/jumbo v0, "accountName"

    iget-object v2, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->ec:Landroid/accounts/Account;
    ...
    iget-boolean v2, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hh:Z

    invoke-virtual {v1, v0, v2}, Lorg/json/JSONObject;->put(Ljava/lang/String;Z)Lorg/json/JSONObject;

    const-string/jumbo v0, "forceCodeForRefreshToken"

    iget-boolean v2, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hj:Z

    invoke-virtual {v1, v0, v2}, Lorg/json/JSONObject;->put(Ljava/lang/String;Z)Lorg/json/JSONObject;

    const-string/jumbo v0, "serverAuthRequested"

    iget-boolean v2, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hi:Z

    invoke-virtual {v1, v0, v2}, Lorg/json/JSONObject;->put(Ljava/lang/String;Z)Lorg/json/JSONObject;

    iget-object v0, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hk:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hk:Ljava/lang/String;

    invoke-virtual {v1, v0, v2}, Lorg/json/JSONObject;->put(Ljava/lang/String;Ljava/lang/Object;)Lorg/json/JSONObject;

    :cond_2
    iget-object v0, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hl:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hl:Ljava/lang/String;
...
.method static synthetic zzc(Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hi:Z
...
.method static synthetic zzd(Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hj:Z
...
.method static synthetic zze(Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;)Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hh:Z
...
.method public static zzfy(Ljava/lang/String;)Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;
    .locals 10
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v1, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hg:Ljava/util/ArrayList;

    invoke-virtual {v1}, Ljava/util/ArrayList;->size()I

    move-result v1

    invoke-virtual {p1}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->zzahj()Ljava/util/ArrayList;
    ...
    iget-object v1, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->ec:Landroid/accounts/Account;
    ...
    :goto_1
    iget-object v1, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hk:Ljava/lang/String;
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->zzahn()Ljava/lang/String;
    ...
    :goto_2
    iget-boolean v1, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hj:Z

    invoke-virtual {p1}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->zzahm()Z

    move-result v2

    if-ne v1, v2, :cond_0

    iget-boolean v1, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hh:Z

    invoke-virtual {p1}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->zzahk()Z

    move-result v2

    if-ne v1, v2, :cond_0

    iget-boolean v1, p0, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->hi:Z

    invoke-virtual {p1}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->zzahl()Z
...
.method public hashCode()I
    ...
    invoke-virtual {v0, v1}, Lcom/google/android/gms/auth/api/signin/internal/zze;->zzbd(Z)Lcom/google/android/gms/auth/api/signin/internal/zze;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/auth/api/signin/internal/zze;->zzahv()I
...
.method public zzahg()Ljava/lang/String;
    ...
    invoke-direct {p0}, Lcom/google/android/gms/auth/api/signin/GoogleSignInOptions;->zzahi()Lorg/json/JSONObject;
...
.method public zzahj()Ljava/util/ArrayList;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
