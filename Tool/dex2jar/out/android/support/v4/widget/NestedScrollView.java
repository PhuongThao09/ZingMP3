    ...
    public boolean onTouchEvent(final MotionEvent motionEvent) {
        ...
        switch (actionMasked) {
            ...
            case 2: {
                ...
                if (n5 < 0) {
                    this.mEdgeGlowTop.onPull(n3 / this.getHeight(), MotionEventCompat.getX(motionEvent, pointerIndex) / this.getWidth());
                    if (!this.mEdgeGlowBottom.isFinished()) {
                        this.mEdgeGlowBottom.onRelease();
                    }
                }
                else if (n5 > scrollRange) {
                    this.mEdgeGlowBottom.onPull(n3 / this.getHeight(), 1.0f - MotionEventCompat.getX(motionEvent, pointerIndex) / this.getWidth());
                    if (!this.mEdgeGlowTop.isFinished()) {
                        this.mEdgeGlowTop.onRelease();
                    }
                }
