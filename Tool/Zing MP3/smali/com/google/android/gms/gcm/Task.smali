...
.field private final afm:Z

.field private final afn:I

.field private final afo:Z

.field private final afp:Lcom/google/android/gms/gcm/zzc;
...
.method constructor <init>(Landroid/os/Parcel;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/gcm/Task;->afk:Ljava/lang/String;
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->afl:Z
    ...
    :goto_1
    iput-boolean v1, p0, Lcom/google/android/gms/gcm/Task;->afm:Z

    const/4 v0, 0x2

    iput v0, p0, Lcom/google/android/gms/gcm/Task;->afn:I

    iput-boolean v2, p0, Lcom/google/android/gms/gcm/Task;->afo:Z

    sget-object v0, Lcom/google/android/gms/gcm/zzc;->aff:Lcom/google/android/gms/gcm/zzc;

    iput-object v0, p0, Lcom/google/android/gms/gcm/Task;->afp:Lcom/google/android/gms/gcm/zzc;
...
.method constructor <init>(Lcom/google/android/gms/gcm/Task$Builder;)V
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->afm:Z
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->afo:Z

    iget-object v0, p1, Lcom/google/android/gms/gcm/Task$Builder;->extras:Landroid/os/Bundle;

    iput-object v0, p0, Lcom/google/android/gms/gcm/Task;->mExtras:Landroid/os/Bundle;

    iget-object v0, p1, Lcom/google/android/gms/gcm/Task$Builder;->afq:Lcom/google/android/gms/gcm/zzc;
...
.method public static zza(Lcom/google/android/gms/gcm/zzc;)V
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/gcm/zzc;->zzboc()I
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/google/android/gms/gcm/zzc;->zzbod()I

    move-result v1

    invoke-virtual {p0}, Lcom/google/android/gms/gcm/zzc;->zzboe()I
    ...
    const-string/jumbo v3, "MaximumBackoffSeconds must be greater than InitialBackoffSeconds: "
...
.method public getRequiredNetwork()I
    ...
    iget v0, p0, Lcom/google/android/gms/gcm/Task;->afn:I
...
.method public getRequiresCharging()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->afo:Z
...
.method public getServiceName()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/gcm/Task;->afk:Ljava/lang/String;
...
.method public isPersisted()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->afm:Z
...
.method public isUpdateCurrent()Z
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/gcm/Task;->afl:Z
...
.method public toBundle(Landroid/os/Bundle;)V
    ...
    iget-boolean v1, p0, Lcom/google/android/gms/gcm/Task;->afl:Z

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    const-string/jumbo v0, "persisted"

    iget-boolean v1, p0, Lcom/google/android/gms/gcm/Task;->afm:Z

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    const-string/jumbo v0, "service"

    iget-object v1, p0, Lcom/google/android/gms/gcm/Task;->afk:Ljava/lang/String;

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putString(Ljava/lang/String;Ljava/lang/String;)V

    const-string/jumbo v0, "requiredNetwork"

    iget v1, p0, Lcom/google/android/gms/gcm/Task;->afn:I

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    const-string/jumbo v0, "requiresCharging"

    iget-boolean v1, p0, Lcom/google/android/gms/gcm/Task;->afo:Z

    invoke-virtual {p1, v0, v1}, Landroid/os/Bundle;->putBoolean(Ljava/lang/String;Z)V

    const-string/jumbo v0, "retryStrategy"

    iget-object v1, p0, Lcom/google/android/gms/gcm/Task;->afp:Lcom/google/android/gms/gcm/zzc;
