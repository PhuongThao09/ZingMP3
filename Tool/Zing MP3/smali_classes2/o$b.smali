...
.method public final synthetic a(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$u;
    ...
    iget-object v1, p0, Lo$b;->c:Lo;

    iget-object v1, v1, Lo;->f:Landroid/view/LayoutInflater;

    iget-object v2, p0, Lo$b;->c:Lo;

    iget-object v2, v2, Lo;->n:Landroid/view/View$OnClickListener;

    invoke-direct {v0, v1, p1, v2}, Lo$g;-><init>(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/view/View$OnClickListener;)V
    ...
    invoke-direct {v0, v1, p1}, Lo$i;-><init>(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)V
    ...
    invoke-direct {v0, v1, p1}, Lo$h;-><init>(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)V
    ...
    iget-object v1, v1, Lo;->b:Landroid/widget/LinearLayout;
...
.method public final synthetic a(Landroid/support/v7/widget/RecyclerView$u;)V
    ...
    .line 3455
    iget-object v0, p1, Lo$j;->a:Landroid/view/View;
...
.method public final synthetic a(Landroid/support/v7/widget/RecyclerView$u;I)V
    ...
    .line 4415
    invoke-virtual {p0, p2}, Lo$b;->b(I)I
    ...
    iget-object v1, v1, Lo;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, v1, Lo;->i:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, v1, Lo;->k:Landroid/graphics/drawable/Drawable;
    ...
    .line 4428
    iget-boolean v2, v1, Lo$f;->b:Z

    invoke-virtual {v0, v2}, Landroid/support/design/internal/NavigationMenuItemView;->setNeedsEmptyIcon(Z)V

    .line 4634
    iget-object v1, v1, Lo$f;->a:Lit;

    .line 4429
    invoke-virtual {v0, v1}, Landroid/support/design/internal/NavigationMenuItemView;->a(Lit;)V
    ...
    .line 4435
    invoke-virtual {v1}, Lit;->getTitle()Ljava/lang/CharSequence;
    ...
    .line 4441
    iget-object v1, p1, Lo$j;->a:Landroid/view/View;
...
.method public final a(Lit;)V
    ...
    invoke-virtual {v0, v1}, Lit;->setChecked(Z)Landroid/view/MenuItem;

    .line 552
    :cond_2
    iput-object p1, p0, Lo$b;->f:Lit;

    .line 553
    const/4 v0, 0x1

    invoke-virtual {p1, v0}, Lit;->setChecked(Z)Landroid/view/MenuItem;
...
.method final b()V
    ...
    .line 480
    iget-object v0, p0, Lo$b;->c:Lo;

    iget-object v0, v0, Lo;->c:Lir;

    invoke-virtual {v0}, Lir;->h()Ljava/util/ArrayList;
    ...
    .line 482
    invoke-virtual {p0, v0}, Lo$b;->a(Lit;)V
    ...
    iget-object v6, p0, Lo$b;->c:Lo;

    iget v6, v6, Lo;->m:I

    const/4 v10, 0x0

    invoke-direct {v2, v6, v10}, Lo$e;-><init>(II)V
    ...
    invoke-direct {v2, v0}, Lo$f;-><init>(Lit;)V
    ...
    .line 498
    invoke-virtual {v1}, Lit;->isVisible()Z
    ...
    invoke-virtual {v1}, Lit;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v12}, Lit;->a(Z)V
    ...
    .line 508
    :cond_6
    iget-object v12, p0, Lo$b;->a:Ljava/util/ArrayList;

    new-instance v13, Lo$f;

    invoke-direct {v13, v1}, Lo$f;-><init>(Lit;)V
    ...
    invoke-direct {p0, v10, v0}, Lo$b;->d(II)V
    ...
    iget-object v5, p0, Lo$b;->c:Lo;

    iget v5, v5, Lo;->m:I

    iget-object v9, p0, Lo$b;->c:Lo;

    iget v9, v9, Lo;->m:I

    invoke-direct {v4, v5, v9}, Lo$e;-><init>(II)V
    ...
    invoke-direct {v3, v0}, Lo$f;-><init>(Lit;)V

    .line 530
    iput-boolean v1, v3, Lo$f;->b:Z
    ...
    .line 527
    iget-object v2, p0, Lo$b;->a:Ljava/util/ArrayList;

    invoke-virtual {v2}, Ljava/util/ArrayList;->size()I

    move-result v2

    invoke-direct {p0, v4, v2}, Lo$b;->d(II)V
...
.method public final c()Landroid/os/Bundle;
    ...
    iget-object v2, p0, Lo$b;->f:Lit;

    invoke-virtual {v2}, Lit;->getItemId()I
