...
public interface fi extends IInterface
{
    ...
    public abstract static class a extends Binder implements fi
    {
        public static fi a(final IBinder binder) {
            if (binder == null) {
                return null;
            }
            ...
            if (queryLocalInterface != null && queryLocalInterface instanceof fi) {
                return (fi)queryLocalInterface;
            }
            return new fi.a.a(binder);
        }
