    ...
    void measureHorizontal(final int n, final int n2) {
        ...
        for (int i = 0; i < virtualChildCount; ++i, n32 = n14, n33 = n13, n10 = n17, n9 = n16, n7 = n15, n4 = n32, n3 = n33) {
            ...
            if (virtualChild == null) {
                ...
                int n27 = layoutParams.bottomMargin + layoutParams.topMargin;
        ...
        if (mUseLargestChild && (mode == Integer.MIN_VALUE || mode == 0)) {
            ...
            for (int j = 0; j < virtualChildCount; ++j) {
                ...
                if (virtualChild2 == null) {
                    ...
                    final LayoutParams layoutParams2 = (LayoutParams)virtualChild2.getLayoutParams();
                    if (b) {
                        this.mTotalLength += layoutParams2.rightMargin + (layoutParams2.leftMargin + n10) + this.getNextLocationOffset(virtualChild2);
                    }
                    else {
                        final int mTotalLength4 = this.mTotalLength;
                        this.mTotalLength = Math.max(mTotalLength4, layoutParams2.rightMargin + (mTotalLength4 + n10 + layoutParams2.leftMargin) + this.getNextLocationOffset(virtualChild2));
                    }
                }
            }
        }
            ...
            while (k < virtualChildCount) {
                ...
                if (virtualChild3 != null) {
                    if (virtualChild3.getVisibility() == 8) {
                        ...
                        final int n49 = layoutParams3.topMargin + layoutParams3.bottomMargin;
    ...
    void measureVertical(final int n, final int n2) {
        ...
        for (int i = 0; i < virtualChildCount; ++i, n26 = n14, n27 = n13, n10 = n16, n9 = n15, n4 = n26, n3 = n27) {
            ...
            if (virtualChild == null) {
                ...
                int n23 = layoutParams.rightMargin + layoutParams.leftMargin;
        ...
        if (mUseLargestChild && (mode2 == Integer.MIN_VALUE || mode2 == 0)) {
            ...
            for (int j = 0; j < virtualChildCount; ++j) {
                ...
                if (virtualChild2 == null) {
                    ...
                    final LayoutParams layoutParams2 = (LayoutParams)virtualChild2.getLayoutParams();
                    final int mTotalLength4 = this.mTotalLength;
                    this.mTotalLength = Math.max(mTotalLength4, layoutParams2.bottomMargin + (mTotalLength4 + n10 + layoutParams2.topMargin) + this.getNextLocationOffset(virtualChild2));
                }
            }
        }
        ...
        if (n9 != 0 || (n28 != 0 && mWeightSum > 0.0f)) {
            ...
            while (k < virtualChildCount) {
                ...
                if (virtualChild3.getVisibility() == 8) {
                    ...
                    if (n34 != 0 && layoutParams3.width == -1) {
                        n34 = 1;
                    }
                    else {
                        n34 = 0;
                    ...
                    final int mTotalLength5 = this.mTotalLength;
                    this.mTotalLength = Math.max(mTotalLength5, layoutParams3.bottomMargin + (virtualChild3.getMeasuredHeight() + mTotalLength5 + layoutParams3.topMargin) + this.getNextLocationOffset(virtualChild3));
                    n37 = max6;
                    final int n49 = n43;
                    n4 = n42;
                    n35 = n49;
