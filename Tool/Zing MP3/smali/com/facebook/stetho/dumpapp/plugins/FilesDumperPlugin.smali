...
.method private doDownload(Ljava/io/PrintStream;Ljava/util/Iterator;)V
    ...
    .prologue
    .line 119
    const-string/jumbo v0, "Must specify output file or \'-\'"
    ...
    .line 122
    iget-object v3, p0, Lcom/facebook/stetho/dumpapp/plugins/FilesDumperPlugin;->mContext:Landroid/content/Context;
    ...
    invoke-static {v3, v0}, Lcom/facebook/stetho/dumpapp/plugins/FilesDumperPlugin;->resolvePossibleAppStoragePath(Landroid/content/Context;Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-static {v1}, Lcom/facebook/stetho/dumpapp/plugins/FilesDumperPlugin;->resolvePossibleSdcardPath(Ljava/lang/String;)Ljava/io/File;
    ...
    invoke-direct {p0, v1, v3, v0}, Lcom/facebook/stetho/dumpapp/plugins/FilesDumperPlugin;->addFiles(Ljava/util/zip/ZipOutputStream;[B[Ljava/io/File;)V
    :try_end_1
...
.method private doUsage(Ljava/io/PrintStream;)V
    ...
    .prologue
    .line 215
    const-string/jumbo v0, "Usage: dumpapp files "
    ...
    const-string/jumbo v1, "download <output.zip> [<path>...]"
    ...
    .line 222
    const-string/jumbo v0, "dumpapp files ls: List files similar to the ls command"
    ...
    .line 224
    const-string/jumbo v0, "dumpapp files tree: List files similar to the tree command"
    ...
    .line 226
    const-string/jumbo v0, "dumpapp files download: Fetch internal application storage"

    invoke-virtual {p1, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 227
    const-string/jumbo v0, "    <output.zip>: Output location or \'-\' for stdout"

    invoke-virtual {p1, v0}, Ljava/io/PrintStream;->println(Ljava/lang/String;)V

    .line 228
    const-string/jumbo v0, "    <path>: Fetch only those paths named (directories fetch recursively)"
