...
.method private calculatePageOffsets(Landroid/support/v4/view/ViewPager$b;ILandroid/support/v4/view/ViewPager$b;)V
    ...
    .line 1322
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;
    ...
    .line 1343
    iget-object v5, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;

    invoke-virtual {v5, v2}, Lfa;->getPageWidth(I)F
    ...
    .line 1383
    iget-object v9, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;

    add-int/lit8 v3, v2, -0x1

    invoke-virtual {v9, v2}, Lfa;->getPageWidth(I)F
...
.method private completeScroll(Z)V
    ...
    invoke-static {p0, v0}, Lfg;->a(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method private enableLayers(Z)V
    ...
    invoke-static {v4, v0, v5}, Lfg;->a(Landroid/view/View;ILandroid/graphics/Paint;)V
...
.method private infoForCurrentScrollPosition()Landroid/support/v4/view/ViewPager$b;
    ...
    .line 2397
    iget-object v6, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;

    iget v7, v0, Landroid/support/v4/view/ViewPager$b;->b:I

    invoke-virtual {v6, v7}, Lfa;->getPageWidth(I)F
...
.method private performDrag(F)Z
    ...
    invoke-virtual {v9}, Lfa;->getCount()I
    ...
    .line 2357
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Lgo;
    ...
    invoke-virtual {v1, v0}, Lgo;->a(F)Z
    ...
    .line 2363
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Lgo;
    ...
    invoke-virtual {v2, v0}, Lgo;->a(F)Z
...
.method private resetTouch()Z
    ...
    .line 2317
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Lgo;

    invoke-virtual {v0}, Lgo;->c()Z

    move-result v0

    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Lgo;

    invoke-virtual {v1}, Lgo;->c()Z
...
.method addNewItem(II)Landroid/support/v4/view/ViewPager$b;
    ...
    .line 1034
    iget-object v1, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;

    invoke-virtual {v1, p0, p1}, Lfa;->instantiateItem(Landroid/view/ViewGroup;I)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p1}, Lfa;->getPageWidth(I)F
...
.method protected canScroll(Landroid/view/View;ZIII)Z
    ...
    invoke-static {p1, v0}, Lfg;->a(Landroid/view/View;I)Z
...
.method public canScrollHorizontally(I)Z
    ...
    .line 2709
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;
...
.method dataSetChanged()V
    ...
    .line 1056
    iget-object v7, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;

    iget-object v9, v0, Landroid/support/v4/view/ViewPager$b;->a:Ljava/lang/Object;

    invoke-virtual {v7, v9}, Lfa;->getItemPosition(Ljava/lang/Object;)I
    ...
    .line 1067
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;

    invoke-virtual {v4, p0}, Lfa;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v6, p0, v7, v9}, Lfa;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v0, p0}, Lfa;->finishUpdate(Landroid/view/ViewGroup;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 2449
    invoke-virtual {v1}, Lfa;->getCount()I
    ...
    .line 2457
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Lgo;

    invoke-virtual {v3, v0, v2}, Lgo;->a(II)V

    .line 2458
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Lgo;

    invoke-virtual {v0, p1}, Lgo;->a(Landroid/graphics/Canvas;)Z
    ...
    .line 2468
    iget-object v4, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Lgo;

    invoke-virtual {v4, v3, v2}, Lgo;->a(II)V

    .line 2469
    iget-object v2, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Lgo;

    invoke-virtual {v2, p1}, Lgo;->a(Landroid/graphics/Canvas;)Z
...
.method public executeKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    .line 2786
    invoke-static {p1}, Len;->b(Landroid/view/KeyEvent;)Z
    ...
    .line 2788
    :cond_1
    invoke-static {p1}, Len;->a(Landroid/view/KeyEvent;)Z
...
.method public fakeDragBy(F)V
    ...
    invoke-virtual {v6}, Lfa;->getCount()I
...
.method infoForChild(Landroid/view/View;)Landroid/support/v4/view/ViewPager$b;
    ...
    invoke-virtual {v2, p1, v3}, Lfa;->isViewFromObject(Landroid/view/View;Ljava/lang/Object;)Z
...
.method initViewPager()V
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->mLeftEdge:Lgo;
    ...
    iput-object v1, p0, Landroid/support/v4/view/ViewPager;->mRightEdge:Lgo;
    ...
    invoke-static {p0, v0}, Lfg;->a(Landroid/view/View;Leh;)V

    .line 421
    invoke-static {p0}, Lfg;->d(Landroid/view/View;)I
    ...
    .line 423
    invoke-static {p0, v4}, Lfg;->c(Landroid/view/View;I)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;
    ...
    iget-object v3, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;

    invoke-virtual {v3, v5}, Lfa;->getPageWidth(I)F
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v0, v1, v2}, Lfa;->restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
...
.method public onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-virtual {v0}, Lfa;->saveState()Landroid/os/Parcelable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v0, v2}, Lff;->a(Landroid/view/VelocityTracker;I)F
...
.method populate(I)V
    ...
    iget-object v2, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;
    ...
    invoke-virtual {v2, v0}, Lfa;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    iget-object v4, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;

    invoke-virtual {v4}, Lfa;->getCount()I
    ...
    iget-object v14, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;

    iget-object v2, v2, Landroid/support/v4/view/ViewPager$b;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v14, v0, v8, v2}, Lfa;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iget-object v10, v0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;

    iget-object v2, v2, Landroid/support/v4/view/ViewPager$b;->a:Ljava/lang/Object;

    move-object/from16 v0, p0

    invoke-virtual {v10, v0, v8, v2}, Lfa;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v3, v0, v4, v2}, Lfa;->setPrimaryItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    invoke-virtual {v2, v0}, Lfa;->finishUpdate(Landroid/view/ViewGroup;)V
...
.method public setAdapter(Lfa;)V
    .locals 7
    ...
    invoke-virtual {v0, v5}, Lfa;->setViewPagerObserver(Landroid/database/DataSetObserver;)V

    .line 508
    iget-object v0, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;

    invoke-virtual {v0, p0}, Lfa;->startUpdate(Landroid/view/ViewGroup;)V
    ...
    .line 511
    iget-object v3, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;
    ...
    invoke-virtual {v3, p0, v4, v0}, Lfa;->destroyItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    .line 521
    iput-object p1, p0, Landroid/support/v4/view/ViewPager;->mAdapter:Lfa;
    ...
    invoke-virtual {v0, v3}, Lfa;->setViewPagerObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {v3}, Lfa;->getCount()I
    ...
    invoke-virtual {v0, v3, v4}, Lfa;->restoreState(Landroid/os/Parcelable;Ljava/lang/ClassLoader;)V
    ...
    invoke-interface {v0, p0, v1, p1}, Landroid/support/v4/view/ViewPager$d;->onAdapterChanged(Landroid/support/v4/view/ViewPager;Lfa;Lfa;)V
...
.method smoothScrollTo(III)V
    ...
    invoke-virtual {v5, v7}, Lfa;->getPageWidth(I)F
