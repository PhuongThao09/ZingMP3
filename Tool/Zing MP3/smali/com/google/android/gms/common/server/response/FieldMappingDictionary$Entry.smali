...
# instance fields
.field final DG:Ljava/util/ArrayList;
...
.method constructor <init>(ILjava/lang/String;Ljava/util/ArrayList;)V
    ...
    iput-object p3, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->DG:Ljava/util/ArrayList;
...
.method constructor <init>(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {p2}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->zzau(Ljava/util/Map;)Ljava/util/ArrayList;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->DG:Ljava/util/ArrayList;

    return-void
.end method

.method private static zzau(Ljava/util/Map;)Ljava/util/ArrayList;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method zzawh()Ljava/util/HashMap;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->DG:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$FieldMapPair;->DH:Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;
