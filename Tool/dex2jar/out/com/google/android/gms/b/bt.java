...
public interface bt extends IInterface
{
    ...
    bn zzdH() throws RemoteException;
    ...
    public abstract static class a extends Binder implements bt
    {
        ...
        public static bt zzx(final IBinder binder) {
            if (binder == null) {
                return null;
            }
        ...
        public boolean onTransact(final int n, final Parcel parcel, final Parcel parcel2, final int n2) throws RemoteException {
            ...
            switch (n) {
                ...
                case 6: {
                    parcel.enforceInterface("com.google.android.gms.ads.internal.formats.client.INativeContentAd");
                    final bn zzdH = this.zzdH();
                    parcel2.writeNoException();
                    IBinder binder4 = binder;
                    if (zzdH != null) {
                        binder4 = zzdH.asBinder();
                    }
        ...
        private static class a implements bt
        {
            ...
            @Override
            public bn zzdH() throws RemoteException {
                final Parcel obtain = Parcel.obtain();
                final Parcel obtain2 = Parcel.obtain();
                try {
                    obtain.writeInterfaceToken("com.google.android.gms.ads.internal.formats.client.INativeContentAd");
