            ...
            Label_0181: {
                ...
                for (int childCount = this.getChildCount(), i = 0; i < childCount; ++i) {
                    ...
                    if (child.getVisibility() != 8) {
                        ...
                        if (this.isContentView(child)) {
                            child.measure(View$MeasureSpec.makeMeasureSpec(n6 - layoutParams.leftMargin - layoutParams.rightMargin, 1073741824), View$MeasureSpec.makeMeasureSpec(n5 - layoutParams.topMargin - layoutParams.bottomMargin, 1073741824));
                        }
                        else {
                            if (!this.isDrawerView(child)) {
