...
.method public constructor <init>(Lcom/google/android/gms/ads/formats/NativeContentAd;)V
    ...
    iput-object p1, p0, Lxu$b;->a:Lcom/google/android/gms/ads/formats/NativeContentAd;
    ...
    invoke-virtual {p0, v0}, Lxu$b;->setHeadline(Ljava/lang/String;)V

    invoke-virtual {p1}, Lcom/google/android/gms/ads/formats/NativeContentAd;->getImages()Ljava/util/List;

    move-result-object v0

    invoke-virtual {p0, v0}, Lxu$b;->setImages(Ljava/util/List;)V
    ...
    invoke-virtual {p0, v0}, Lxu$b;->setBody(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lxu$b;->setLogo(Lcom/google/android/gms/ads/formats/NativeAd$Image;)V
    ...
    invoke-virtual {p0, v0}, Lxu$b;->setCallToAction(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lxu$b;->setAdvertiser(Ljava/lang/String;)V

    invoke-virtual {p0, v1}, Lxu$b;->setOverrideImpressionRecording(Z)V

    invoke-virtual {p0, v1}, Lxu$b;->setOverrideClickHandling(Z)V
...
.method public final trackView(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lxu$b;->a:Lcom/google/android/gms/ads/formats/NativeContentAd;
